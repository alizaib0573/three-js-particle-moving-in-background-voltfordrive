 ...
 * http://modernizr.com/download/?-audio-backgroundblendmode-bgsizecover-canvas-cssanimations-cssfilters-csspointerevents-csstransforms-csstransforms3d-csstransitions-cssvhunit-flexbox-geolocation-hashchange-history-objectfit-svg-svgasimg-touchevents-video-webgl-prefixed-prefixedcss-shiv !*/
! function(e, t, n) {
    function r(e, t) {
        return typeof e === t
    }
    ...
    function o() {
        ...
        for (var c in x) {
            ...
            for (o = r(t.fn, "function") ? t.fn() : t.fn, a = 0; a < e.length; a++) i = e[a], s = i.split("."), 1 === s.length ? Modernizr[s[0]] = o : (!Modernizr[s[0]] || Modernizr[s[0]] instanceof Boolean || (Modernizr[s[0]] = new Boolean(Modernizr[s[0]])), Modernizr[s[0]][s[1]] = o), b.push((o ? "" : "no-") + s.join("-"))
        }
    }
    ...
    function m(e, n, r, o) {
        var a, i, s, u, l = "modernizr",
            d = c("div"),
            f = p();
        if (parseInt(r, 10))
            for (; r--;) s = c("div"), s.id = o ? o[r] : l + (r + 1), d.appendChild(s);
        return a = c("style"), a.type = "text/css", a.id = "s" + l, (f.fake ? f : d).appendChild(a), f.appendChild(d), a.styleSheet ? a.styleSheet.cssText = e : a.appendChild(t.createTextNode(e)), d.id = l, f.fake && (f.style.background = "", f.style.overflow = "hidden", u = C.style.overflow, C.style.overflow = "hidden", C.appendChild(f)), i = n(d, e), f.fake ? (f.parentNode.removeChild(f), C.style.overflow = u, C.offsetHeight) : d.parentNode.removeChild(d), !!i
    }
    ...
    function v(e, t, o, i) {
        ...
        for (var d, f, p, m, v, g = ["modernizr", "tspan"]; !F.style;) d = !0, F.modElem = c(g.shift()), F.style = F.modElem.style;
        for (p = e.length, f = 0; p > f; f++)
            if (m = e[f], v = F.style[m], l(m, "-") && (m = a(m)), F.style[m] !== n) {
    ...
    function g(e, t, n, o, a) {
        ...
        return r(t, "string") || r(t, "undefined") ? v(s, t, o, a) : (s = (e + " " + $.join(i + " ") + i).split(" "), f(s, t, n))
    }
    ...
    var b = [],
        ...
        Modernizr = function() {};
    Modernizr.prototype = T, Modernizr = new Modernizr, Modernizr.addTest("geolocation", "geolocation" in navigator), Modernizr.addTest("history", function() {
    ...
    S || ! function(e, t) {
        ...
        function u(e) {
            e || (e = t);
            var r = a(e);
            return !b.shivCSS || l || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), d || c(e, r), e
        }
        var l, d, f = "3.7.3",
            p = e.html5 || {},
    ...
    var w = function(e) {
        function n(t, n) {
            var o;
            return t ? (n && "string" != typeof n || (n = c(n || "div")), t = "on" + t, o = t in n, !o && r && (n.setAttribute || (n = c("div")), n.setAttribute(t, ""), o = "function" == typeof n[t], n[t] !== e && (n[t] = e), n.removeAttribute(t)), o) : !1
        }
        var r = !("onblur" in t.documentElement);
        return n
    }();
    T.hasEvent = w, Modernizr.addTest("hashchange", function() {
    ...
    var L = T.prefixed = function(e, t, n) {
        return 0 === e.indexOf("@") ? k(e) : (-1 != e.indexOf("-") && (e = a(e)), t ? g(e, t, n) : g(e, "pfx"))
    };
    ...
    Modernizr.addTest("backgroundblendmode", L("backgroundBlendMode", "text")), Modernizr.addTest("objectfit", !!L("objectFit"), {
        aliases: ["object-fit"]
    }), T.testAllProps = y, Modernizr.addTest("cssanimations", y("animationName", "a", !0)), Modernizr.addTest("bgsizecover", y("backgroundSize", "cover")), Modernizr.addTest("flexbox", y("flexBasis", "1px", !0)), Modernizr.addTest("cssfilters", function() {
        ...
        if (e && (!t || "webkitPerspective" in C.style)) {
            var n;
            Modernizr.supports ? n = "@supports (perspective: 1px)" : (n = "@media (transform-3d)", t && (n += ",(-webkit-transform-3d)")), n += "{#modernizr{left:9px;position:absolute;height:5px;margin:0;padding:0;border:0}}", A(n, function(t) {
                e = 9 === t.offsetLeft && 5 === t.offsetHeight
            })
        }
        return e
    }), Modernizr.addTest("csstransitions", y("transition", "all", !0)), o(), i(b), delete T.addTest, delete T.addAsyncTest;
